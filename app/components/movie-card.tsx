...
function MovieCard({
  ...
  return (
    <Card
      className="w-full max-w-sm rounded-lg overflow-hidden shadow-xl mb-8 mx-8
    ...
    >
      <div className="relative">
        ...
        <div
          className="flex items-center justify-center absolute top-4 left-4 bg-gray-900 text-white px-2 py-1 rounded-md text-sm font-medium
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">{plot}</p>
